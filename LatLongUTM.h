...
#ifndef RNDMNKIII_LatLongUTM_H
#define RNDMNKIII_LatLongUTM_H
...
const double PI_UTM       = 4*atan(1);  //Gantz used: PI=3.14159265;
const double deg2rad  = PI_UTM/180;
const double rad2deg  = 180/PI_UTM;
